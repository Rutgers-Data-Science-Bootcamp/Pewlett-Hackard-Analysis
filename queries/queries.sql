...
--There are 7 types of joins in SQL
...
--inner join these two tables for the 
...
SELECT ri.emp_no,
       ...
       ri.last_name,
di.dept_name
INTO sales_Devop_retirement_info
FROM retirement_info AS ri
INNER JOIN dept_info AS di
ON (ri.emp_no = di.emp_no)
WHERE di.dept_name  IN ('Sales', 'Development');

SELECT * FROM sales_Devop_retirement_info;
